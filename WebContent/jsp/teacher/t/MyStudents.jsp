...
<body bgcolor="#e5eecc">
	<form name="Seekfrom"
		action="${pageContext.request.contextPath}/Grade_Servlet?id=seek"
	...
	<table align="center" width="1000" border="1" height="120"
		...
		<c:forEach items="${requestScope.list}" var="s">
			<tr align="center" bgcolor="white">
				...
				<td><a
					href="${pageContext.request.contextPath}/Grade_Servlet?id=grade&sNo=${s.getNo()}&cNo=${s.getcNo()}">评分</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
