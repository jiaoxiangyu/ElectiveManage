...
<body bgcolor="#e5eecc">
	<form name="Seekfrom"
		action="${pageContext.request.contextPath}/RemoveCourse_Servlet"
	...
	<table align="center" width="1000" border="1" height="120"
		...
		<c:forEach items="${requestScope.list}" var="c">
			<tr align="center" bgcolor="white">
				...
				<td>${c.getTeacher()}</td>
				<td><a
					href="${pageContext.request.contextPath}/RemoveCourse_Servlet?id=remove&No=${c.getNo()}">删除</a></td>
				<td><a
					href="${pageContext.request.contextPath}/UpdateCourse_Servlet?No=${c.getNo()}">修改</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
